  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<AppUser?>(
      ...
      builder: (context, userSnapshot) {
        ...
        return StreamBuilder<AppUser>(
          stream: firestoreService.streamUser(user.id),
          builder: (context, streamSnapshot) {
            ...
            final updatedUser = streamSnapshot.data!;
            ...
            return Scaffold(
              ...
              body: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                        'Bonjour ${updatedUser.firstName} ${updatedUser.lastName}'),
                    Text('DeeVee: ${updatedUser.deeVee}'),
                    Text('Grains d\'or: ${updatedUser.goldGrains}'),
                    const SizedBox(height: 20),
                    Expanded(
                      child: FutureBuilder<bool>(
                        future: hasReadyPlants(context, updatedUser.id),
